        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-6">
              We purchased sales navigator enterprise plan and collaborated with LinkedIn employees for extended discount.
              Your email only required, we directly activate on your email.
            </p>
          </div>
